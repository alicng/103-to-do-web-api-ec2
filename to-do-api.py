...
app.config['MYSQL_DATABASE_PASSWORD'] = 'Ali'
...
# Write a function named `home` which returns 'Welcome to the Ali's To-Do API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Ali's To-Do API Service"
